      ...
      <div class="container clearfix">
        ...
        <div class="logo">
          <a class="logo__link" href="../index.php">
            <img class="logo__img" src="images/logo.png" alt="merctech megashop logotype" width="237" height="19">
          </a>
        </div>
                ...
                <div class="clearfix">
                  <div class="dropdown__half">
                    ...
                    <ul class="dropdown__items">
                      ...
                      <li class="dropdown__item">
                        <a href="my_account.php?cart.php" class="dropdown__link">View Shopping Cart</a>
                      </li>
                    </ul>
                  </div>
                  <div class="dropdown__half">
