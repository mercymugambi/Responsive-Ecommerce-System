...
<label class="col-md-3 control-label">User County: </label>

<div class="col-md-6"><!-- col-md-6 Starts -->

<input type="text" name="admin_county" class="form-control" required value="<?php echo $admin_county; ?>">
...
$update_admin = "update admins set admin_name='$admin_name',admin_email='$admin_email',admin_pass='$admin_pass',admin_image='$admin_image',admin_contact='$admin_contact',admin_county='$admin_county',admin_job='$admin_job',admin_about='$admin_about' where admin_id='$admin_id'";
